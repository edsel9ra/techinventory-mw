            ...
            <div class="row">
                ...
                <div class="col-auto">
                    <?php if ($_SESSION['rol_id'] == 1 || $_SESSION['rol_id'] == 3) { ?>
                        <button id="btnRegistrarEquipo"
                            class="btn btn-primary fw-bold d-flex align-items-center gap-2 justify-content-center flex-nowrap">
                ...
                <div class="mb-3 row">
                    <div class="col filtros d-flex align-items-center" style="width: 120px;">
                        <div class="input-group mb-2">
                            <label class="input-group-text fw-bold mr-2">Filtrar por tipo</label>
                            <select id="filtroTipo" class="form-select form-control-sm">
                                <option value="">Todos</option>
                            </select>
                        </div>
                    </div>
                    <div class="col filtros d-flex align-items-center" style="width: 100px;">
                        <div class="input-group mb-2">
                            <label class="input-group-text fw-bold mr-2">Filtrar por estado</label>
                            <select id="filtroEstado" class="form-select form-control-sm">
                                <option value="">Todos</option>
                            </select>
                        </div>
                    </div>
                    <div class="col filtros d-flex align-items-center" style="width: 120px;">
                        <div class="input-group mb-2">
                            ...
                            <select id="filtroSede" class="form-select form-control-sm">
                                <option value="">Todos</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-auto d-flex align-items-center">
                        <button id="btnLimpiarFiltros" class="btn btn-outline-secondary btn-sm ms-2 mb-2"
                            style="display: none;">
                            Limpiar filtros
                        </button>
                    </div>
